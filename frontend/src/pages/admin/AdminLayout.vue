      ...
      <aside class="w-64 bg-gray-800 shadow-2xl p-4">
        <nav>
          <ul class="space-y-2">
            ...
            <li>
              <router-link to="/admin/students" class="flex items-center px-3 py-2 text-sm font-medium rounded-lg hover:bg-gray-700">
                <svg class="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 3a3 3 0 013 3v1a3 3 0 11-6 0V6a3 3 0 013-3zm-6 9a4 4 0 014-4h4a4 4 0 014 4v2a1 1 0 01-1 1H5a1 1 0 01-1-1v-2z" clip-rule="evenodd"></path></svg>
                Manage Students
              </router-link>
            </li>
            <li>
